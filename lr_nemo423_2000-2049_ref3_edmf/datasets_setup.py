...
# --         > python3 atlas_CM.py -p params_My_Comparison.py                                     - |
# --                                                                                             - |
...
# --              * Then run the atlas: > python3 atlas_CM.py [arguments]                         - |
...
# --> case atCNRM:
from my_projects import *
period='2000-2049'
if atCNRM:
    models = [

           dict(project = 'N4CPL',
           model='CNRM-CM62-LR',  period="1900-1949", mip='CMIP', frequency='monthly',
           experiment='AOGCM_drv632_NEMO422_LR_t7', customname='CM67_N4_REF', root='/cnrm/ioga/Users/voldoire/NO_SAVE/NEMO4/LR')
    ,
           dict(project = 'N3CPL',
           model='CNRM-CM62-LR',  period=period, mip='CMIP', frequency='monthly',
           experiment='CM67_N4_3_REF3', customname='REF3', root='/cnrm/ioga/Users/voldoire/NO_SAVE/NEMO4/LR')
    ,
           dict(project = 'N3CPL',
           model='CNRM-CM62-LR',  period=period, mip='CMIP', frequency='monthly',
           experiment='CM67_N4_3_edmf_stab', customname='REF3 + EDMF', root='/cnrm/ioga/Users/voldoire/NO_SAVE/NEMO4/LR')
