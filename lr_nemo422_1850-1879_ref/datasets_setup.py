...
if atCNRM:
    models = [
           ...
           experiment='AOGCM_drv632_NEMO421_LR_t6', customname='NEMO4.2.2', root='/cnrm/ioga/Users/voldoire/NO_SAVE/NEMO4/LR')
    ,
           dict(project = 'N3CPL',
           model='CNRM-CM62-LR',  period=period, mip='CMIP', frequency='monthly',
           experiment='piC-LR_633_oas5_x2553_trip_t0d', customname='NEMO3', root='/cnrm/ioga/Users/voldoire/NO_SAVE/CM6/REFNEMO4')
